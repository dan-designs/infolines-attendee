...
export default function LoginScreen() {
  ...
  // Swapped username for email to match Supabase Auth
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Ensure we clear out any old guest status
      await AsyncStorage.removeItem('isGuest');
      
      // Success! Route to feed
    ...
    >
      <View style={styles.header}>
        <View style={styles.titleRow}>
          <Text style={[styles.title, { color: themeColor }]}>Login</Text>
      ...
      >
        <View style={styles.formContainer}>
          ...
          <TouchableOpacity 
            onPress={() => router.push('/password_reset')}
      ...
      <View style={[styles.actionContainer, isKeyboardVisible && styles.actionContainerKeyboardOpen]}>
        ...
        {!isKeyboardVisible && (
          <>
            ...
            <View style={styles.buttonWrapper}>
              <Button title="Continue As Guest" onPress={handleGuestAccess} variant="ghost" />
            </View>
          </>
        )}
      </View>
